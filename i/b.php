...
?>   
    <tr>
        ...
        <td><img src="images/<?php echo $data['p_id'];?>.<?php echo $data['p-ext'];?>"width="100"></td>
        <td width="80" align="center"><a href="delete_provinces.php?id=<?php echo $data['r_id']; ?>&ext=<?php echo $data['p_ext'];?>" onClick="return confirm('ยืนยันการลบ?');"><img src="images/delete.jpg" width="50"></a></td>
    </tr>
<?php } ?>
</table>
